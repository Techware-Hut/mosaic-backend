...
/**
 * Normalize Service.location from API input for updates.
 * Accepts a plain string (legacy clients) or `{ address }`.
 * Returns:
 *  - `undefined` when the field was omitted (leave existing location alone)
 *  - trimmed address string (empty string means clear)
 */
const extractServiceLocationAddress = (location) => {
