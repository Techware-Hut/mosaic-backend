...
| 6 | Product description renders HTML | Frontend sanitizes description text; backend returns raw description by design. | Fixed pending UAT | Corrective Work / Bug implemented pending client review | P2 Medium | Ready for Client Review | Frontend |
...
| 8 | Cart quantity cannot be reduced | Fixed through persisted `cartItemId` update path. | Fixed pending UAT | Corrective Work / Bug implemented pending client review | P0 fix implemented | Ready for Client Review | Both |
| 9 | Coupon applies for all cart values | Fixed through backend subtotal validation. | Fixed pending UAT | Corrective Work / Bug implemented pending client review | P0 fix implemented | Ready for Client Review | Backend |
| 10 | Cart and checkout amounts differ | Fixed by backend PR #199 and frontend PR #323/#324. | Fixed pending UAT | Corrective Work / Bug implemented pending client review | P0 fix implemented | Ready for Client Review | Both |
