...
| [#31](https://github.com/Techware-Hut/mosaic-backend/issues/31) | Vendor profile/listings/orders | Business, product, order vendor routes + `listingTierLimits` — **merged PR #40; live on production** | 16 vendor listing/order/stock tests (**123/123** total) | Tier-limit/stock/vendor-order smoke **PENDING** disposable accounts | Product+variant tier limit aligned; see [MVP_BACKEND_VENDOR_SELF_SERVICE_APIS.md](MVP_BACKEND_VENDOR_SELF_SERVICE_APIS.md) |
...
4. ~~**#31 Vendor MVP APIs**~~ — **Done (PR #40 merged + deployed `2134231`):** product+variant tier limits, stock guards, vendor order tests + [MVP_BACKEND_VENDOR_SELF_SERVICE_APIS.md](MVP_BACKEND_VENDOR_SELF_SERVICE_APIS.md)
